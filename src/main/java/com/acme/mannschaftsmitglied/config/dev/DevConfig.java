...
package com.acme.mannschaftsmitglied.config.dev;
...
public class DevConfig implements
    com.acme.mannschaftsmitglied.config.dev.LogRequestHeaders,
    com.acme.mannschaftsmitglied.config.dev.Flyway,
    com.acme.mannschaftsmitglied.config.dev.K8s {
    /**
