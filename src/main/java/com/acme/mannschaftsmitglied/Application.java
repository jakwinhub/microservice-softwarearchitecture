...
import com.acme.mannschaftsmitglied.config.AppConfig;
import com.acme.mannschaftsmitglied.config.dev.DevConfig;
...
import static com.acme.mannschaftsmitglied.config.Banner.TEXT;
...
@SuppressWarnings({"ImplicitSubclassInspection", "ClassUnconnectedToPackage", "AnnotationUseStyle"})
