...
Helm Chart für mannschaftsmitglied
...
| Name | Email | Url |
| ---- | ------ | --- |
| Jakob Winkler | <wija1023@h-ka.de> | <https://www.h-ka.de> |
...
| image.name | string | `"mannschaftsmitglied"` | Name des Image |
...
| logLevel.application | string | `"info"` | Loglevel für kunde als Umgebungsvariable |
